...
TEMPLATE_TEST_CASE_SIG("Insert in vector with size = V through iterator and size", "[vector] [insert]",
	...
	SECTION("at the middle") {
		...
		ft_vector.insert(ft_it, V / 2, 21);
		vector.insert(it, V / 2, 21);
	...
	SECTION("at the end") {
		ft_vector.insert(ft_vector.end(), V / 2, 21);
		vector.insert(vector.end(), V / 2, 21);
...
TEMPLATE_TEST_CASE_SIG("Insert in vector with size = V through two iterator", "[vector] [insert]",
	...
	SECTION("From beginning to middle at the front") {
		ft_vector.insert(ft_vector.begin(), V / 2, 21);
		vector.insert(vector.begin(), V / 2, 21);
	...
	SECTION("From beginning to middle at the end") {
		ft_vector.insert(ft_vector.begin(), V / 3, 21);
		vector.insert(vector.begin(), V / 3, 21);
	...
	SECTION("From the middle to the end at the back") {
		ft_vector.insert(ft_vector.begin(), V / 4, 21);
		vector.insert(vector.begin(), V / 4, 21);
