...
/*   Updated: 2020/10/26 17:59:20 by imicah           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
	...
	public:
		...
		bool	operator==(const rev_random_access_iterator<T> &x) { return (*_ptr == *x._ptr); }
		bool	operator!=(const rev_random_access_iterator<T> &x) { return (*_ptr != *x._ptr); }
		bool	operator<(const rev_random_access_iterator<T> &x) { return (*_ptr < *x._ptr); }
		bool	operator<=(const rev_random_access_iterator<T> &x) { return (*_ptr <= *x._ptr); }
		bool	operator>(const rev_random_access_iterator<T> &x) { return (*_ptr > *x._ptr); }
		...
		rev_random_access_iterator<T>	operator+(rev_random_access_iterator<T> &x)
																	{ return (_ptr + x._ptr); }
		rev_random_access_iterator<T>	operator-(rev_random_access_iterator<T> &x)
																	{ return (_ptr + x._ptr); }
		rev_random_access_iterator<T>	operator+=(rev_random_access_iterator<T> &x) {
	...
	public:
		...
		const_rev_random_access_iterator(const const_rev_random_access_iterator<T> &x)
																			: _ptr(x._ptr) { }
		const_rev_random_access_iterator(const rev_random_access_iterator<T> &x)
																			: _ptr(x._get_ptr()) { }
		~const_rev_random_access_iterator() { }

		const_rev_random_access_iterator<T>	&operator=(
													const const_rev_random_access_iterator<T> &x) {
			if (this != &x)
				_ptr = x._ptr;
			return (*this);
		}
		...
		bool	operator==(const const_rev_random_access_iterator<T> &x)
																	{ return (*_ptr == *x._ptr); }
		bool	operator!=(const const_rev_random_access_iterator<T> &x)
																	{ return (*_ptr == *x._ptr); }
		bool	operator<(const const_rev_random_access_iterator<T> &x)
		...
		const_rev_random_access_iterator<T>	operator+(const_rev_random_access_iterator<T> &x)
																		{ return (_ptr + x._ptr); }
